...
async function getCudaLocalInstallerUrl(version, os8, arch3) {
  ...
  if (majorVersion <= 10 && os8 === "linux" /* LINUX */ && arch3 === "arm64-sbsa" /* ARM64_SBSA */) {
    throw new Error(
  ...
  if (version in CUDA_LINKS) {
    ...
    if (os8 === "linux" /* LINUX */ && arch3 === "arm64-sbsa" /* ARM64_SBSA */ && link.linuxArm64Url) {
...
async function installCudaLocal(version, os8, arch3) {
  ...
  const downloadDestination = os8 === "windows" /* WINDOWS */ ? getWindowsInstallerDownloadPath(filename) : filename;
